...
TableTools = function( oDT, oOpts )
{
	...
	/**
	 * @namespace Settings object which contains customisable info for TableTools instance
	 */
	this.s = {
		/**
		...
		/**
		 * @namespace Select rows specific info
		 */
		"select": {
			/**
	...
	this.dom = {
		...
		"print": {
			...
			/**
			 * The info display saying telling the user about the print display
			 *  @property message
			 *  @type	 node
			 *  @default  null
			 */
...
TableTools.prototype = {
	...
	/**
	 * Get the info contained in a table as a string
	 *  @param   {Object} oConfig Button configuration object
	 ...
	 * 
	 * This function is required for large info sets. There is a limit on the 
	...
	"_fnPrintStart": function ( oConfig )
	{
	  ...
	  var oSetDT = this.s.dt;
		...
		/* Show info message to let the user know what is happening */
		if ( oConfig.sInfo !== "" )
		{
